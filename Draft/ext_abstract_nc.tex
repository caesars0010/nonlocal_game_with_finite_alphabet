...
% The correlation extended from the ideal correlation that achieves $\I_{\cot(-\pi/d)}^{\max}$
% can be seen as a test of binary observables 
% used in the strategy of the linear system game.  
