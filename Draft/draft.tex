...
\hf{We generalize this relation and make he solution group of $\LS$ the embedding of the 
following group}
\begin{align}
...
\begin{proposition}
	...
	with the numbers of variables and equations linear in $r$, where each equation involves $3$ variables.
