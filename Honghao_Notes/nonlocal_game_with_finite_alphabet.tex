...
\begin{proposition}
	...
	then 
	\begin{align}
		M_{\nr+1} M_j \ket{\psi} \appd{O(r\se)} M_{j} M_{\nr+1} \ket{\psi} &&
		M_{\nr+2} M_j \ket{\psi} \appd{O(r\se)} M_{j} M_{\nr+2} \ket{\psi} &&
	\end{align}
...
This proposition is an application of Lemma~$28$ of \cite{coladan2017verifier} with $\se$ replaced by $O(r\se)$.
