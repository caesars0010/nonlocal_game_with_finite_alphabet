...
relate $U_B(X_B+X_B\ct)U_B\ct B_{n_r+1}^\diamond \ket{\psi}$ to $2\cos(\frac{(r+1)\pi}{d}) B_{n_r+1}^\diamond \ket{\psi}$.
...
\begin{align}
	...
	\appd{O(2^{r+1}\epsilon^{1/4})} \cos(\frac{(r+1)\pi}{d}) B_{n_r+1}^\diamond\ket{\psi},
\end{align}
or equivalently,
\begin{align}
...
the Hermitian matrix $X_B +X_B\ct$ with eigenvalue $2\cos(\frac{(r+1)\pi}{d})$.
...
\begin{align}
\bra{\psi}B_{n_r+1}^\diamond U_B\ct B_{n_r+1}^\diamond \ket{\psi} = O(\frac{2^{r+1}\epsilon^{1/4}}{\cos(2\pi/d) - \cos((r+1)\pi/d)}).
\end{align}
